...
contract ActivatedToken is ERC20 {
    ...
    modifier onlyVault() {
        require(
            ...
            "ActivatedToken: Caller is not the Vault"
        );
        _;
    }
        ...
        nonReentrant
    {
        require(
            _account != address(0),
            "ActivatedToken: Mint to the zero address"
        );
        ...
        nonReentrant
    {
        require(
            _account != address(0),
            "ActivatedToken: Burn from the zero address"
        );
        if (_amount == 0) {
            return;
        }
    ...
    function rebaseOptIn() public nonReentrant {
        require(
            ...
            "ActivatedToken: Account has not opted out"
        );
    ...
    function rebaseOptOut() public nonReentrant {
        require(
            !_isNonRebasingAccount(msg.sender),
            "ActivatedToken: Account has not opted in"
        );
        ...
        nonReentrant
    {
        ...
        require(
            ...
            "ActivatedToken: Invalid change in supply"
        );
     ...
     */
    function convertToAssets(uint _creditBalance)
        public
        view
        returns (uint assets)
    {
     ...
     */
    function convertToCredits(uint _tokenBalance)
        public
        view
        returns (uint credits)
    {
